...
apt install unzip nginx mariadb-server mariadb-client php8.1 php8.1-intl php8.1-fpm php8.1-mysql php-common php8.1-cli php8.1-common php8.1-opcache php8.1-readline php8.1-mbstring php8.1-xml php8.1-gd php8.1-curl php8.1-zip git nodejs npm -y
# apt install acl
