...
class RepairService
{
     ...
     */
    public function createOrUpdateRepair(int $assetId, string $issue, ArrayCollection $partsNeeded, string $status = 'not_started', array $actionsTaken = [], ?int $submittedByUserId = null): void
    {
