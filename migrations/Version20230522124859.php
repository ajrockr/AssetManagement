 ...
 */
final class Version20230522124859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN pending BOOLEAN DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, roles, password, email, location, department, phone, extension, title, homepage, manager, google_id, microsoft_id, date_created, surname, firstname, enabled FROM user');
        ...
        $this->addSql('INSERT INTO user (id, username, roles, password, email, location, department, phone, extension, title, homepage, manager, google_id, microsoft_id, date_created, surname, firstname, enabled) SELECT id, username, roles, password, email, location, department, phone, extension, title, homepage, manager, google_id, microsoft_id, date_created, surname, firstname, enabled FROM __temp__user');
